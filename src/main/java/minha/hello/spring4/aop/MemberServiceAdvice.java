...
public class MemberServiceAdvice {
    ...
    //    * 패키지.클래스.메서드(..) => *은 모든 접근지정자, (..) : 매개변수명시x 한개든 두개든 상관없다)
    @Pointcut("execution(* minha.hello.spring4.controller.MemberController.myinfo(..))")
    public void myInfoPoint(){}
    @Pointcut("execution(* minha.hello.spring4.controller.MemberController.join(..))")
